...
import { getAllPosts, getAllVideoPosts, getCategories } from "@/datas/post";
...
export default async function VideoPage({ searchParams }: SearchPageProps) {
    const user = await currentUser();

    const categories = await getCategories();

    const posts = await getAllVideoPosts(searchParams);
