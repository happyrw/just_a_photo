...
import { getAllImagePosts, getAllPosts, getCategories } from "@/datas/post";
...
export default async function PhotosPage({ searchParams }: SearchPageProps) {
    const user = await currentUser();

    const categories = await getCategories();

    const posts = await getAllImagePosts(searchParams);
